...
public class AdvertisementBannerController {
    ...
    @ApiOperation(value = "광고 전체 리스트", notes = "광고 전체 리스트를 반환합니다.")
    @ApiResponses(value = {
            @ApiResponse(code = 201, message = "광고 리스트 반환 성공"),
    ...
    @ApiOperation(value = "랜덤 광고", notes = "랜덤으로 광고 하나를 반환합니다.")
    @ApiResponses(value = {
            @ApiResponse(code = 201, message = "랜덤 광고 반환 성공"),
            @ApiResponse(code = 500, message = "서버 에러")
    })
    @GetMapping("/random")
